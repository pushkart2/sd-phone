...
export const GLYPH_NAMES: string[] = [
    ...
    'friends_search', 'garage_bike', 'garage_car', 'garage_truck', 'garages',
    ...
    'map_pin', 'map_pinned', 'map_route', 'maps', 'message_bubble', 'message_more', 'message_send',
    'message_text',
    ...
    'streaks', 'streaks_calendar', 'streaks_check', 'streaks_kindling', 'vibez',
