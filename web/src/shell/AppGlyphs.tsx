import {
    ...
    Cloudy, Club, Cog, Coins, Columns4, Compass, Contact, CreditCard, Crosshair,
    Diamond, Dices, Disc3, Divide, DoorOpen, Download, Dumbbell, Earth, Egg, EyeOff,
    ...
    ScanFace, ScanSearch, ScrollText, Search, Send, Settings, Shield, ShieldCheck, Ship,
