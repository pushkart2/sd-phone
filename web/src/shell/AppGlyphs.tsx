import {
    ...
    BoomBox, Briefcase, Building, Bus, Calculator, CalendarCheck,
    CalendarClock, CalendarDays, CalendarPlus, CalendarRange, Camera, Car, CarFront,
    CarTaxiFront, Cherry, CircleCheckBig,
    ...
    Music, Navigation, Navigation2, Newspaper, Notebook, Package, Paperclip, PenLine,
    Percent, Phone, PhoneCall, PhoneIncoming, PhoneOutgoing, PiggyBank, Pill, Play, Plus, Podcast,
    Radar, Radio, RadioTower, ReceiptText, Route, Rss, Sailboat, Satellite,
    ...
    Sparkle, Sparkles, Speaker, Star, StarHalf, Stethoscope, StickyNote, Store,
    Sun, SwitchCamera, Tag, Target, ThumbsUp, Ticket, Timer, ToggleRight,
    TrainTrack, TramFront, Truck, Tv, TvMinimal, UserRound,
    UserSearch, Vault, Video, Voicemail, Wallet, Warehouse, Waves, Waypoints,
    Wrench, Zap,
} from 'lucide-react';
