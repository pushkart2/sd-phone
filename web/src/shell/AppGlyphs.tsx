import {
    ...
    CarTaxiFront, ChartBar, ChartCandlestick, ChartLine, Cherry, CircleCheckBig,
    CircleDollarSign, CircleDot, Clapperboard, Clock, Cloud, CloudDownload, CloudRain, CloudSun,
    Cloudy, Cog, Coins, Columns4, Compass, Contact, CreditCard, Crosshair,
    ...
    Hourglass, House, IdCard, Image as ImageIcon, Images, Inbox, Joystick, Key, KeyRound,
    ...
    TrainTrack, TramFront, TrendingDown, TrendingUp, Truck, Tv, TvMinimal, UserRound,
