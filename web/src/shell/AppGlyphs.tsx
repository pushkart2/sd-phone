import {
    Activity, AlarmClock, Anchor, Aperture, AppWindow, Archive, AudioLines, AudioWaveform,
    BadgeCheck, Banknote, BedDouble, Bike, Bird, Book, Bookmark, BookMarked, BookOpen,
    Briefcase, Building, Calculator, CalendarCheck,
    CalendarClock, CalendarDays, CalendarPlus, CalendarRange, Camera, CarFront, Cherry, CircleCheckBig,
    CircleDollarSign, CircleDot, Clapperboard, Clock, Cloud, CloudDownload, CloudRain, CloudSun,
    Cog, Coins, Columns4, Compass, CreditCard, Crosshair,
    Disc3, Divide, DoorOpen, Download, Dumbbell, Earth, Egg, EyeOff,
    FileText, Film, FingerprintPattern, Flag, Flame, FlameKindling, Flower2, Focus, Folder,
    FolderOpen, Frame, GalleryHorizontalEnd, GalleryVerticalEnd, Gift, Globe, Grid2x2,
    Hammer, HardHat, Hash, Headphones, Headset, Heart, HeartHandshake, HeartPulse,
    Hourglass, House, IdCard, Image as ImageIcon, Images, Inbox, Key, KeyRound,
    Landmark, Link, ListMusic, ListTodo, LocateFixed, Lock,
    LockKeyhole, Mail, Mailbox, MailOpen, Map, MapPin, MapPinned, Medal, Megaphone, MessageCircle,
    MessageCircleMore, MessageSquare, MessageSquareText, MessagesSquare, Mic, MicVocal,
    Music, Navigation, Navigation2, Newspaper, Notebook, Paperclip, PenLine,
    Percent, Phone, PhoneCall, PhoneIncoming, PhoneOutgoing, PiggyBank, Pill, Play, Plus, Podcast,
    Radar, ReceiptText, Route, Rss, Sailboat, Satellite,
    ScanFace, ScanSearch, ScrollText, Search, Send, Settings, Shield, ShieldCheck,
    ShipWheel, ShoppingBag, Skull, SlidersHorizontal, Snowflake,
    Sparkle, Sparkles, Star, StarHalf, Stethoscope, StickyNote,
    Sun, SwitchCamera, Target, ThumbsUp, Ticket, Timer, ToggleRight,
    TrainTrack, TramFront, Truck, Tv, TvMinimal, UserRound,
    UserSearch, Vault, Video, Voicemail, Wallet, Warehouse, Waves,
    Wrench, Zap,
} from 'lucide-react';
