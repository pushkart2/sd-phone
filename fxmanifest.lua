...
author 'Samuel#0008'
version '1.0.3'
description 'Full-featured in-game smartphone covering calls, messages, mail, social feeds, banking, garages, housing, jobs, maps, camera, music and games, plus home screen widgets, icon themes you can design, cell tower and Wi-Fi coverage, payphones, unique phones and SIM cards, an API for third-party apps and widgets, and lb-phone compatibility'
